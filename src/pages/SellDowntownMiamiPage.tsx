    ...
    <>
      ...
      <main className="min-h-screen bg-white-soft grain-overlay pb-20 lg:pb-0">
        ...
        <section className="relative overflow-hidden bg-navy-deep px-6 pt-20 pb-10 md:pt-28 md:pb-12 text-center sm:px-10">
          <LazyVideo eager src="/videos/cinematic_house_reach.mp4" className="absolute inset-0 h-full w-full object-cover opacity-[0.14] pointer-events-none" />
          ...
          <div className="relative">
            ...
            <blockquote className="mx-auto mt-5 max-w-md border-l-2 border-gold/30 pl-4 text-left">
              ...
              <footer className="mt-2 font-mono text-[9px] uppercase tracking-[0.18em] text-gold/50">— Marco V., Downtown Miami, FL</footer>
            </blockquote>
