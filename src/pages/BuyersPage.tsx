  ...
  return (
    <>
      ...
      <JsonLd id="buyers-service" data={{
          ...
          "description": "Buyer representation including professional MLS search, neighborhood analysis, offer strategy, and closing coordination across Miami-Dade, Broward, and Palm Beach counties — backed by United Realty Group's 3,500+ agents and 21 Florida offices.",
      ...
      <JsonLd id="buyers-faq" data={{
          ...
          "mainEntity": [
            ...
            { "@type": "Question", "name": "What does United Realty Group's size mean for me as a buyer?", "acceptedAnswer": { "@type": "Answer", "text": "United Realty Group has 3,500+ agents across 21 Florida offices. For a buyer, that supports local coordination and buyer-agent cooperation across South Florida, subject to brokerage, platform, and compliance requirements." } },
