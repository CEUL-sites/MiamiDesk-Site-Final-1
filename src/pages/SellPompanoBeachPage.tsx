        ...
        <section className="bg-ivory py-12 md:py-16">
          <div className="mx-auto max-w-5xl px-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <a href="/journal/selling-pompano-beach-home-2026" className="block border border-hairline bg-white p-6 hover:border-gold/40 transition-colors">
                <p className="font-mono text-[9px] uppercase tracking-[0.18em] text-gold/70 mb-3">Seller Strategy</p>
                <h3 className="font-serif text-lg text-navy-deep leading-snug">Selling Your Pompano Beach Home in 2026 — Coastal, Intracoastal, and Inland Positioning</h3>
          ...
          <div className="mx-auto max-w-5xl px-6">
            <div className="mb-10 text-center">
              ...
              <p className="mx-auto mt-4 max-w-xl font-sans text-sm leading-relaxed text-white/50">
                No listing commitment required. Carlos reviews every Pompano Beach submission personally before responding — typically within one business day.
              </p>
            </div>
            <SellerIntakeForm />
