  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Pompano Beach, FL listing agent — MLS positioning, seasonal and investor buyer activation, coastal and intracoastal market strategy. Free strategy review." />
        ...
        <section className="relative overflow-hidden bg-navy-deep px-6 pt-20 pb-10 md:pt-28 md:pb-12 text-center sm:px-10">
          ...
          <div className="relative">
            ...
            <blockquote className="mx-auto mt-5 max-w-md border-l-2 border-gold/30 pl-4 text-left">
              ...
              <footer className="mt-2 font-mono text-[10px] uppercase tracking-[0.18em] text-gold/50">— Thomas E., Pompano Beach, FL</footer>
            </blockquote>
