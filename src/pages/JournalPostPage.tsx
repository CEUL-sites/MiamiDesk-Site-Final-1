  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="alternate" hrefLang="x-default" href={`https://homesprofessional.com/journal/${post.slug}`} />
        <link rel="alternate" hrefLang="en" href={`https://homesprofessional.com/journal/${post.slug}`} />
