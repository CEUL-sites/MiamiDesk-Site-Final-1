  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white-soft grain-overlay pb-20 lg:pb-0">
        <Navbar />
        {/* Single hero + form section. Previously two stacked navy blocks
            repeated near-identical eyebrows ("Confidential · Private Review" /
            "…Desk") and headings ("Request a Private Listing Review" / "Submit
            your listing for private review"), pushing the form down. Merged so
            the form sits directly under one heading. */}
