...
export default function SellHallandaleBeachPage() {
  return (
    <>
      ...
      <JsonLd id="sell-hallandale-beach-breadcrumb" data={{
      ...
      <JsonLd id="sell-hallandale-beach-faq" data={{
          "@context": "https://schema.org",
          "@type": "FAQPage",
      ...
      <JsonLd id="sell-hallandale-beach-agent" data={{
          "@context": "https://schema.org",
      ...
      <JsonLd id="sell-hallandale-beach-service" data={{
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Seller representation and MLS listing — Hallandale Beach, FL",
          "serviceType": "Real estate listing and seller representation",
          "areaServed": { "@type": "City", "name": "Hallandale Beach", "addressRegion": "FL", "addressCountry": "US" },
          "provider": {
            "@type": "RealEstateAgent",
      ...
      <main id="main-content" className="min-h-screen bg-white-soft grain-overlay pb-20 lg:pb-0">
          ...
          <div className="relative">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              <a href="#contact" className="group inline-flex items-center gap-2 bg-gold px-8 py-3.5 font-mono text-[11px] uppercase tracking-[0.2em] text-navy-deep transition-opacity hover:opacity-90">
                Get My Hallandale Beach Home Value &amp; Strategy
            ...
            <blockquote className="mx-auto mt-5 max-w-md border-l-2 border-gold/30 pl-4 text-left">
              <p className="font-sans text-sm italic leading-relaxed text-white/55">"Hallandale condo buyers are almost entirely international or seasonal. Carlos's connections to those buyer pipelines differentiated him from every other agent I interviewed."</p>
              <footer className="mt-2 font-mono text-[10px] uppercase tracking-[0.18em] text-gold/50">— Isabel P., Hallandale Beach, FL</footer>
            </blockquote>
        ...
        <section className="border-t border-gold/20 bg-navy py-12 md:py-20 text-white">
          <div className="mx-auto max-w-4xl px-6">
            ...
            <FaqAccordion faqs={HALLANDALE_BEACH_FAQS} />
          </div>
        </section>
        ...
        <NearbyMarkets current="sell-hallandale-beach" />
