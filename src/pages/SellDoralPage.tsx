        ...
        <section className="relative overflow-hidden bg-navy-deep px-6 pt-20 pb-10 md:pt-28 md:pb-12 text-center sm:px-10">
          ...
          <div className="relative">
            ...
            <div className="mt-3 flex items-center justify-center">
              <a href="/es/vender-doral" className="font-mono text-[10px] uppercase tracking-[0.18em] text-gold/70 underline-offset-2 hover:text-gold hover:underline">
          ...
          <div className="mx-auto max-w-5xl px-6">
            <div className="mb-10 text-center">
              ...
              <p className="mx-auto mt-4 max-w-xl font-sans text-sm leading-relaxed text-white/50">
                No listing commitment required. Carlos reviews every Doral submission personally before responding — typically within one business day.
              </p>
            </div>
            <SellerIntakeForm />
