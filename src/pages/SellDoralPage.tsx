        ...
        <section className="relative overflow-hidden bg-navy-deep px-6 pt-20 pb-10 md:pt-28 md:pb-12 text-center sm:px-10">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-6 max-w-2xl font-sans text-base leading-relaxed text-white/60">
              Doral's master-planned communities and the highest LATAM buyer concentration in Miami-Dade demand an agent who knows both markets. MLS positioning. Buyer-agent activation. International distribution.
            </p>
