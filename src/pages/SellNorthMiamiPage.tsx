        ...
        <section className="bg-ivory py-12 md:py-16">
          <div className="mx-auto max-w-5xl px-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <a href="/journal/selling-north-miami-home-2026" className="block border border-hairline bg-white p-6 hover:border-gold/40 transition-colors">
                <p className="font-mono text-[9px] uppercase tracking-[0.18em] text-gold/70 mb-3">Seller Strategy</p>
                <h3 className="font-serif text-lg text-navy-deep leading-snug">Selling Your North Miami Home in 2026 — What a Growing Submarket Requires</h3>
