  ...
  return (
    <>
      ...
      <JsonLd id="sell-north-miami-service" data={{
          ...
          "areaServed": { "@type": "City", "name": "North Miami", "addressRegion": "FL", "addressCountry": "US" },
          "provider": {
            "@type": "RealEstateAgent",
      ...
      <main id="main-content" className="min-h-screen bg-white-soft grain-overlay pb-20 lg:pb-0">
        ...
        <section className="relative overflow-hidden bg-navy-deep px-6 pt-20 pb-10 md:pt-28 md:pb-12 text-center sm:px-10">
          <LazyVideo idle src="/videos/hand_house_reach.mp4" className="absolute inset-0 h-full w-full object-cover opacity-[0.14] pointer-events-none" />
          ...
          <div className="relative">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              <a href="#contact" className="group inline-flex items-center gap-2 bg-gold px-8 py-3.5 font-mono text-[11px] uppercase tracking-[0.2em] text-navy-deep transition-opacity hover:opacity-90">
                Get My North Miami Home Value &amp; Strategy
            ...
            <blockquote className="mx-auto mt-5 max-w-md border-l-2 border-gold/30 pl-4 text-left">
              <p className="font-sans text-sm italic leading-relaxed text-white/55">"We needed a realistic pricing strategy relative to the coastal markets nearby. Carlos gave us a clear picture and helped us reach the right buyer pool."</p>
              <footer className="mt-2 font-mono text-[10px] uppercase tracking-[0.18em] text-gold/50">— Natalie A., North Miami, FL</footer>
            </blockquote>
        ...
        <section className="border-t border-gold/20 bg-navy py-12 md:py-20 text-white">
          <div className="mx-auto max-w-4xl px-6">
            ...
            <FaqAccordion faqs={NORTH_MIAMI_FAQS} />
          </div>
        </section>
        ...
        <NearbyMarkets current="sell-north-miami" />
