...
const COPY = {
  en: {
    ...
    sub: "Carlos lists Spanish luxury property into the Miami MLS as a Florida Licensed Realtor® — the third-largest MLS in the United States. Your property reaches 93,000 member agents and 1 million+ international professionals while local Spain buyer access continues through affiliated Madrid agencies. Both channels run simultaneously. Not a referral. A formal listing.",
    ...
    argBody: "The Miami and South Florida REALTORS® MLS is the third-largest MLS in the United States — 93,000 member agents across Miami-Dade, Broward, Palm Beach, St. Lucie and parts of Martin counties, syndicated to 200+ global websites in 19 languages, with an international referral network reaching 1 million+ professionals across 300+ partner associations in 70+ countries. The merger that created it took effect May 11, 2026.",
    stats: [
    ...
    mechanism: [
      ...
      { step: "03", title: "How the Miami MLS exposure activates", body: "On entry, the listing reaches 93,000 member agents, syndicates to 200+ global websites in 19 languages, and enters the international referral network of 1 million+ professionals across 300+ partner associations in 70+ countries. Both channels run simultaneously." },
    ],
