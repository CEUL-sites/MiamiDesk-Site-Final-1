...
const COPY = {
  en: {
    ...
    argBody: "The Miami and South Florida REALTORS® MLS is the world's largest local REALTOR® association — 93,000 member agents across Miami-Dade, Broward, Palm Beach, St. Lucie and parts of Martin counties, eligible listings distributed across 500+ global websites in 19 languages where available, with an international referral network reaching 2 million+ professionals across 300+ partner associations in 70+ countries.",
    stats: [
    ...
    mechanism: [
      ...
      { step: "03", title: "How the Miami MLS exposure activates", body: "On entry, the listing reaches 93,000 member agents, eligible listings may be distributed across 500+ global websites in 19 languages, and enters the international referral network of 2 million+ professionals across 300+ partner associations in 70+ countries. Both channels run simultaneously." },
    ],
