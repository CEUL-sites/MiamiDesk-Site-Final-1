    ...
    <>
      <Helmet>
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "description": "Confidential buyer and seller referral program for licensed agents. Formal referral agreements with United Realty Group. 300+ international partner associations.",
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "mainEntity": [
            ...
            { "@type": "Question", "name": "Do you accept international agent referrals?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. We have 300+ partner associations with international real estate organizations. Bilingual English/Spanish service is available for Spain and Latin America referrals." } }
          ]
        })}</script>
      </Helmet>
        ...
        <section className="py-10 md:py-14">
          <div className="mx-auto max-w-5xl px-6">
            <div className="grid gap-8 md:grid-cols-3">
              {[
                { title: "300+", sub: "Partner Associations", desc: "Signed partnerships with real estate associations across 70+ countries." },
