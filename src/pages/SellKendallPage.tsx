...
export default function SellKendallPage() {
  return (
    <>
      ...
      <JsonLd id="sell-kendall-breadcrumb" data={{
      ...
      <JsonLd id="sell-kendall-faq" data={{
          "@context": "https://schema.org",
          "@type": "FAQPage",
      ...
      <JsonLd id="sell-kendall-agent" data={{
          "@context": "https://schema.org",
      ...
      <JsonLd id="sell-kendall-service" data={{
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Seller representation and MLS listing — Kendall, FL",
          "serviceType": "Real estate listing and seller representation",
          "areaServed": { "@type": "City", "name": "Kendall", "addressRegion": "FL", "addressCountry": "US" },
          "provider": {
            "@type": "RealEstateAgent",
      ...
      <main id="main-content" className="min-h-screen bg-white-soft grain-overlay pb-20 lg:pb-0">
        ...
        <section className="relative overflow-hidden bg-navy-deep px-6 pt-20 pb-10 md:pt-28 md:pb-12 text-center sm:px-10">
          <LazyVideo idle src="/videos/luxury_listing_showcase.mp4" className="absolute inset-0 h-full w-full object-cover opacity-[0.14] pointer-events-none" />
          ...
          <div className="relative">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              <a href="#contact" className="group inline-flex items-center gap-2 bg-gold px-8 py-3.5 font-mono text-[11px] uppercase tracking-[0.2em] text-navy-deep transition-opacity hover:opacity-90">
                Get My Kendall Home Value &amp; Strategy
            ...
            <blockquote className="mx-auto mt-5 max-w-md border-l-2 border-gold/30 pl-4 text-left">
              <p className="font-sans text-sm italic leading-relaxed text-white/55">"Suburban Miami-Dade needs community-level expertise. Carlos understood the school zone, HOA dynamics, and buyer profile for our street — not just generic Kendall advice."</p>
              <footer className="mt-2 font-mono text-[10px] uppercase tracking-[0.18em] text-gold/50">— Diana R., Kendall, FL</footer>
            </blockquote>
        ...
        <section className="border-t border-gold/20 bg-navy py-12 md:py-20 text-white">
          <div className="mx-auto max-w-4xl px-6">
            ...
            <FaqAccordion faqs={KENDALL_FAQS} />
          </div>
        </section>
          ...
          <div className="mx-auto max-w-5xl px-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <a href="/journal/latin-american-buyers-south-florida-2026" className="block border border-hairline bg-white p-6 hover:border-gold/40 transition-colors">
                <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-gold/70 mb-3">Buyer Intelligence</p>
        ...
        <CityListingsSample city="Kendall" />
        <NearbyMarkets current="sell-kendall" />
          ...
          <div className="mx-auto max-w-5xl px-6">
            <div className="mb-10 text-center">
              ...
              <p className="mx-auto mt-4 max-w-xl font-sans text-sm leading-relaxed text-white/50">
                No listing commitment required. Carlos reviews every Kendall submission personally before responding.
              </p>
            </div>
            <SellerIntakeForm sourcePage="sell-kendall" />
