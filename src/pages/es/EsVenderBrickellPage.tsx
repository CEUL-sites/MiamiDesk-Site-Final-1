      ...
      <main id="main-content" className="min-h-screen bg-white-soft grain-overlay pb-20 lg:pb-0">
            ...
            <div className="grid gap-12 md:grid-cols-2 md:items-center">
              <div>
                ...
                <p className="mt-6 font-sans text-base leading-relaxed text-white/65">
                  ...
                  en la red de una correduría de servicio completo fundada en 2002 — más de 3.500 agentes en 19 ubicaciones de oficinas
                ...
                <ul className="mt-8 space-y-3">
                  {[
                    ...
                    "United Realty Group — 3.500+ agentes en 19 ubicaciones de oficinas en Florida",
        ...
        <section className="border-t border-gold/20 bg-navy py-12 md:py-20 text-white">
          <div className="mx-auto max-w-4xl px-6">
            ...
            <FaqAccordion faqs={BRICKELL_FAQS_ES} />
          </div>
        </section>
