        ...
        <section className="bg-bone/40 py-20">
          <div className="mx-auto max-w-5xl px-6">
            ...
            <div className="mt-12 grid grid-cols-2 gap-px bg-bone sm:grid-cols-4">
              ...
              <div className="bg-white p-6 text-center">
                <div className="font-serif text-3xl text-navy-deep">300+</div>
                <div className="mt-1 font-mono text-[9px] uppercase tracking-[0.2em] text-gold/70">
                  {/* TODO: native Madrid editor review */}
                  Asociaciones socias
                </div>
            ...
            <div className="mx-auto mt-12 max-w-3xl space-y-6">
              {[
                ...
                },
                {
                  ...
                  // TODO: native Madrid editor review
                  description:
                    "El listado aparece en más de 500 sitios web en 19 idiomas en 24 a 48 horas. Contacto directo con agentes de South Florida con mandatos activos.",
                },
                {
                  number: "04",
                  // TODO: native Madrid editor review
