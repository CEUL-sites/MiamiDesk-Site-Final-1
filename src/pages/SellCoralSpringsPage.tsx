        ...
        <section className="relative overflow-hidden bg-navy-deep px-6 pt-20 pb-10 md:pt-28 md:pb-12 text-center sm:px-10">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-6 max-w-2xl font-sans text-base leading-relaxed text-white/60">
              Coral Springs' A-rated schools and planned communities attract a deep family buyer pool where school-zone positioning directly drives demand. MLS positioning. Buyer-agent activation. International distribution.
            </p>
