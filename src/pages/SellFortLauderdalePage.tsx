...
export default function SellFortLauderdalePage() {
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Sell Your Fort Lauderdale, FL Home | Professional MLS Positioning | Carlos Uzcategui" />
        <meta property="og:description" content="Professional seller representation in Fort Lauderdale, FL — waterfront MLS activation, international buyer-agent network access, and global portal distribution. Free confidential strategy review." />
        <meta property="og:image" content="https://homesprofessional.com/images/og-default.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Sell Your Fort Lauderdale, FL Home | Carlos Uzcategui, FL SL705771" />
        <meta name="twitter:description" content="Professional MLS positioning and waterfront buyer activation for Fort Lauderdale, FL home sellers. Free strategy review — no listing commitment." />
        <meta name="twitter:image" content="https://homesprofessional.com/images/og-default.png" />
      </Helmet>
      <JsonLd id="sell-fort-lauderdale-breadcrumb" data={{
          "@context": "https://schema.org",
          "@type": "BreadcrumbList",
          "itemListElement": [
            { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://homesprofessional.com/" },
            { "@type": "ListItem", "position": 2, "name": "Sell in South Florida", "item": "https://homesprofessional.com/sell-south-florida" },
            { "@type": "ListItem", "position": 3, "name": "Sell in Fort Lauderdale", "item": "https://homesprofessional.com/sell-fort-lauderdale" }
          ]
        }} />
      <JsonLd id="sell-fort-lauderdale-faq" data={{
          "@context": "https://schema.org",
          "@type": "FAQPage",
          "mainEntity": FORT_LAUDERDALE_FAQS.map(faq => ({
            "@type": "Question",
            "name": faq.q,
            "acceptedAnswer": { "@type": "Answer", "text": faq.a }
          }))
        }} />
      <JsonLd id="sell-fort-lauderdale-agent" data={{
          "@context": "https://schema.org",
          "@type": "RealEstateAgent",
          "name": "Carlos Uzcategui — Fort Lauderdale FL Listing Agent",
          "url": "https://homesprofessional.com/sell-fort-lauderdale",
          "areaServed": { "@type": "City", "name": "Fort Lauderdale", "addressRegion": "FL", "postalCode": "33301", "addressCountry": "US" },
      ...
      <JsonLd id="sell-fort-lauderdale-service" data={{
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Seller representation and MLS listing — Fort Lauderdale, FL",
          "serviceType": "Real estate listing and seller representation",
          "areaServed": { "@type": "City", "name": "Fort Lauderdale", "addressRegion": "FL", "addressCountry": "US" },
          "provider": {
            "@type": "RealEstateAgent",
      ...
      <main id="main-content" className="min-h-screen bg-white-soft grain-overlay pb-20 lg:pb-0">
        ...
        <section className="relative overflow-hidden bg-navy-deep px-6 pt-20 pb-10 md:pt-28 md:pb-12 text-center sm:px-10">
          <LazyVideo idle src="/videos/luxury_waterfront_drone.mp4" className="absolute inset-0 h-full w-full object-cover opacity-[0.18] pointer-events-none" />
          ...
          <div className="relative">
            <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-gold">Fort Lauderdale, FL · Seller Advisory</p>
            <h1 className="mx-auto mt-6 max-w-4xl font-serif leading-tight text-white" style={{ fontSize: "clamp(1.9rem, 5.5vw, 3.2rem)" }}>
              Sell your Fort Lauderdale property with the reach<br />
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              <a href="#contact" className="group inline-flex items-center gap-2 bg-gold px-8 py-3.5 font-mono text-[11px] uppercase tracking-[0.2em] text-navy-deep transition-opacity hover:opacity-90">
                Get My Fort Lauderdale Home Value &amp; Strategy
            ...
            <blockquote className="mx-auto mt-5 max-w-md border-l-2 border-gold/30 pl-4 text-left">
              <p className="font-sans text-sm italic leading-relaxed text-white/55">"The waterfront market has unique positioning requirements. Carlos's analysis was property-specific, not generic. That mattered for attracting the right buyer."</p>
              <footer className="mt-2 font-mono text-[10px] uppercase tracking-[0.18em] text-gold/50">— David H., Fort Lauderdale, FL</footer>
            </blockquote>
        ...
        <section className="bg-ivory py-14 md:py-20">
          <div className="mx-auto max-w-5xl px-6">
            <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-gold">Why Fort Lauderdale</p>
            ...
            <p className="mt-6 max-w-3xl font-sans text-base leading-relaxed text-ink-primary/65">
              Fort Lauderdale's waterway infrastructure, Las Olas corridor, and international airport access create
              a layered real estate market with genuine global demand. European buyers — attracted by direct
              transatlantic access — combine with Latin American and North American buyers to sustain waterfront
              pricing across economic cycles. The city's diverse inventory from urban condos to deep-water estate
              homes serves a buyer pool few other Broward markets can match.
            </p>
            <div className="mt-10 grid gap-px border border-hairline bg-hairline sm:grid-cols-3">
              {[
                { label: "Market Character", value: "Waterfront Premium", sub: "165+ miles of navigable waterways — dock type drives valuation" },
                { label: "Buyer Profile", value: "International + Local", sub: "European, LATAM, and North American demand across segments" },
                { label: "Key Corridors", value: "Las Olas + Intracoastal", sub: "Distinct neighborhoods serve distinct buyer pools" },
              ].map((stat) => (
            ...
            <div className="grid gap-12 md:grid-cols-2 md:items-center">
              <div>
                ...
                <h2 className="mt-5 font-serif text-3xl leading-tight md:text-4xl">
                  Your Fort Lauderdale listing reaches every buyer,<br />
        ...
        <section className="border-t border-gold/20 bg-navy py-12 md:py-20 text-white">
          <div className="mx-auto max-w-4xl px-6">
            <div className="mb-12 text-center">
              <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-gold">Fort Lauderdale Sellers Ask</p>
              <h2 className="mt-4 font-serif text-4xl leading-tight text-white lg:text-5xl">Common questions.</h2>
            </div>
            <FaqAccordion faqs={FORT_LAUDERDALE_FAQS} />
          </div>
        </section>
        ...
        <section className="bg-ivory py-12 md:py-16">
          <div className="mx-auto max-w-5xl px-6">
            <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-gold mb-6">Fort Lauderdale Market Research</p>
            <div className="grid gap-4 sm:grid-cols-2">
              <a href="/journal/selling-fort-lauderdale-waterfront-2026" className="block border border-hairline bg-white p-6 hover:border-gold/40 transition-colors">
        ...
        <NeighborhoodMarketStats city="Fort Lauderdale" />
        <CityListingsSample city="Fort Lauderdale" />
        <NearbyMarkets current="sell-fort-lauderdale" />

        {/* Confidential intake */}
        <section className="bg-navy-deep py-16 md:py-24" id="contact">
          <div className="mx-auto max-w-5xl px-6">
            <div className="mb-10 text-center">
              <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-gold">Fort Lauderdale Seller Review</p>
              ...
              <p className="mx-auto mt-4 max-w-xl font-sans text-sm leading-relaxed text-white/50">
                No listing commitment required. Carlos reviews every Fort Lauderdale submission personally before responding.
              </p>
            </div>
            <SellerIntakeForm sourcePage="sell-fort-lauderdale" />
