        ...
        <section className="bg-ivory py-12 md:py-16">
          <div className="mx-auto max-w-5xl px-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <a href="/journal/what-is-my-home-worth-south-florida-2026" className="block border border-hairline bg-white p-6 hover:border-gold/40 transition-colors">
                <p className="font-mono text-[9px] uppercase tracking-[0.18em] text-gold/70 mb-3">Seller Intelligence</p>
                <h3 className="font-serif text-lg text-navy-deep leading-snug">What Is My Home Worth in South Florida 2026 — How Agents Price and What Sellers Can Do</h3>
                <p className="mt-2 font-sans text-sm text-ink-primary/55">Read the pricing guide →</p>
              </a>
