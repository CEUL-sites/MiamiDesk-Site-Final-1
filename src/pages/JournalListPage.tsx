  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Market analysis and seller guides for South Florida real estate — HOA financials, closing costs, and timing strategy. Carlos Uzcategui, FL SL705771." />
