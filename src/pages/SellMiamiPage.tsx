        ...
        <section className="relative overflow-hidden bg-navy-deep px-6 pt-20 pb-10 md:pt-28 md:pb-12 text-center sm:px-10">
          ...
          <div className="relative">
            ...
            <div className="mt-3 flex items-center justify-center">
              <a href="/es/vender-miami" className="font-mono text-[10px] uppercase tracking-[0.18em] text-gold/70 underline-offset-2 hover:text-gold hover:underline">
        ...
        <section className="bg-ivory py-12 md:py-16">
          <div className="mx-auto max-w-5xl px-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <a href="/journal/selling-miami-home-2026" className="block border border-hairline bg-white p-6 hover:border-gold/40 transition-colors">
                <p className="font-mono text-[9px] uppercase tracking-[0.18em] text-gold/70 mb-3">Seller Strategy</p>
                <h3 className="font-serif text-lg text-navy-deep leading-snug">Selling Your Miami Home in 2026 — Submarket, Buyer, and Documentation Strategy</h3>
                <p className="mt-2 font-sans text-sm text-ink-primary/55">Read the seller guide →</p>
              </a>
              <a href="/journal/south-florida-april-2026-market-signal-home-sellers" className="block border border-hairline bg-white p-6 hover:border-gold/40 transition-colors">
                <p className="font-mono text-[9px] uppercase tracking-[0.18em] text-gold/70 mb-3">Market Analysis</p>
                <h3 className="font-serif text-lg text-navy-deep leading-snug">South Florida's April 2026 Market Signal for Home Sellers</h3>
                <p className="mt-2 font-sans text-sm text-ink-primary/55">Read the market signal →</p>
              </a>
