...
export const URG_CITIES = [
  ...
  { city: "Davie", region: "Broward County" },
  { city: "Cooper City", region: "Broward County" },
  { city: "Tamarac", region: "Broward County" },
  { city: "Coconut Creek", region: "Broward County" },
  { city: "Margate", region: "Broward County" },
  { city: "Lauderhill", region: "Broward County" },
  { city: "Lighthouse Point", region: "Broward County" },
  { city: "Dania Beach", region: "Broward County" },
  { city: "Oakland Park", region: "Broward County" },
  { city: "North Lauderdale", region: "Broward County" },
  ...
  { city: "Boynton Beach", region: "Palm Beach County" },
  { city: "Wellington", region: "Palm Beach County" },
  { city: "Jupiter", region: "Palm Beach County" },
  { city: "Palm Beach Gardens", region: "Palm Beach County" },
  { city: "Royal Palm Beach", region: "Palm Beach County" },
  { city: "Lake Worth Beach", region: "Palm Beach County" },
  { city: "Greenacres", region: "Palm Beach County" },
  { city: "Riviera Beach", region: "Palm Beach County" },
  { city: "Miami", region: "Miami-Dade County" },
  { city: "Coral Gables", region: "Miami-Dade County" },
  { city: "Brickell", region: "Miami-Dade County" },
  { city: "Downtown Miami", region: "Miami-Dade County" },
  { city: "Coconut Grove", region: "Miami-Dade County" },
  { city: "Aventura", region: "Miami-Dade County" },
  { city: "Miami Beach", region: "Miami-Dade County" },
  { city: "Sunny Isles Beach", region: "Miami-Dade County" },
  { city: "Bal Harbour", region: "Miami-Dade County" },
  { city: "Key Biscayne", region: "Miami-Dade County" },
  { city: "Miami Lakes", region: "Miami-Dade County" },
  { city: "Doral", region: "Miami-Dade County" },
  { city: "Hialeah", region: "Miami-Dade County" },
  { city: "Hialeah Gardens", region: "Miami-Dade County" },
  { city: "North Miami", region: "Miami-Dade County" },
  { city: "North Miami Beach", region: "Miami-Dade County" },
  { city: "Miami Gardens", region: "Miami-Dade County" },
  { city: "Kendall", region: "Miami-Dade County" },
  { city: "Pinecrest", region: "Miami-Dade County" },
  { city: "Palmetto Bay", region: "Miami-Dade County" },
