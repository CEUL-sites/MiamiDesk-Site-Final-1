...
const STEPS = [
  ...
  },
  {
    ...
    sub: "Prepared through Miami Global Listing Desk, a prime Spanish property can be reviewed by Miami-area buyer agents through a professional brokerage framework, subject to platform and compliance requirements.",
    stat: "Selected inventory. Professional buyer-agent activation.",
    side: "right" as const,
    color: GOLD_DEEP,
  },
  {
