      ...
      <div className="border-t border-white/5 px-6 py-8">
        <div className="mx-auto max-w-7xl space-y-8">
          <p className="max-w-5xl font-sans text-[10px] font-light leading-loose text-white/25">
            {CONTACT.licenseDisplay}. Associate in {CONTACT.brokerage}. Equal Housing Opportunity. REALTOR® is a registered collective membership mark that identifies a real estate professional who is a member of the National Association of REALTORS® and subscribes to its Code of Ethics. Live MLS ticker data powered by Bridge IDX; listing information is deemed reliable but not guaranteed and is subject to change without notice. MLS display, syndication, association, brokerage, and portal statements reflect current Miami and South Florida REALTORS® membership and should be verified against current compliance materials before use. Information on this website is for general informational purposes only and is not legal, tax, financial, immigration, or investment advice.
          </p>
