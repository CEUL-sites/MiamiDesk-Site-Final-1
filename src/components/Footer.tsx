...
const ticker = "SOUTH FLORIDA · MIAMI MLS EXPOSURE · UNITED REALTY GROUP · INTERNATIONAL PROPERTY DISTRIBUTION · 25 YEARS LICENSED IN FLORIDA · GLOBAL DESK · SPAIN · LATIN AMERICA · 94,000+ ASSOCIATION MEMBERS · ";
...
export function Footer() {
  return (
    ...
    <footer className="relative overflow-hidden bg-navy-deep text-white border-t-2 border-gold/30 pb-24 lg:pb-16">
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-2 gap-5 px-6 py-6 md:gap-12 md:py-16 lg:grid-cols-5">
        <div className="col-span-2 lg:col-span-1">
          <img
            ...
            height="48"
            loading="lazy"
            className="mb-4 h-10 w-auto opacity-85 md:mb-5"
      ...
      <div className="relative z-10 border-t border-white/5 px-6 py-4 md:py-10">
