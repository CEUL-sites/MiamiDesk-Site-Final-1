...
const STEPS = [
  ...
  },
  {
    ...
    badge: "4,000+ Agents · 21 Offices",
    text: "United Realty Group's 4,000+ agents across 21 Florida offices begin showing, qualifying buyers, following up — and activating the Spain & LATAM referral pipeline.",
    stats: [{ v: "3.5K+", l: "Active Agents" }, { v: "20", l: "Offices" }, { v: "2", l: "Continents" }],
      ...
      <div className="sss-page">
        <div className="sss-inner">
          ...
          <div className="sss-cta">
            ...
            <a href="/sell-south-florida" className="sss-btn sss-btn-outline">Explore Our Exposure System →</a>
          </div>
