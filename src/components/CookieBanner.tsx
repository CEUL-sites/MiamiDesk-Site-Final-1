...
export function CookieBanner() {
  ...
  return (
    <div
      ...
      className="fixed bottom-0 left-0 right-0 z-[9999] border-t border-gold/20 bg-navy-deep px-6 py-5 shadow-2xl md:bottom-6 md:left-6 md:right-auto md:max-w-md md:border md:border-gold/25"
    >
