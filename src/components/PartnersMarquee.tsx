export function PartnersMarquee() {
  ...
  return (
    <section id="partners" className="border-y border-gold/15 bg-navy-deep py-16 text-white">
        ...
        <div className="marquee-track-slow gap-0">
          {items.map((item, index) => (
            <div key={`${item}-${index}`} className="flex items-center gap-6 px-7">
              <span className="whitespace-nowrap font-mono text-[10px] uppercase tracking-[0.22em] text-white/45">{item}</span>
      ...
      <div className="mt-10 text-center">
        <p className="font-mono text-[9px] uppercase tracking-[0.22em] text-gold/45">
