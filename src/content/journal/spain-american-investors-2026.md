---
title: "Buying Property in Spain as an American in 2026: Regulation, Tax, and What It Does to Your Yield"
seoTitle: "Buying Property in Spain as an American: 2026 Guide"
date: "2026-08-07"
slug: "spain-american-investors-2026"
excerpt: "Regional purchase taxes, the 24% non-EU rental rule, tourist licensing after the May 2026 Supreme Court ruling, and exit costs for U.S. buyers in Spain."
category: "International"
image: "/images/journal/og/spain-american-investors-2026.jpg"
created_by: "claude"
market: "Spain"
...
**Resale property** carries *Impuesto de Transmisiones Patrimoniales* (ITP), set by each autonomous community and ranging from 4% in the Basque Country to 13% at the top of Catalonia's tier for high-value property. Madrid applies a general 6%. Andalucía applies 7%. Valencia and Galicia reach 10%. Catalonia's Decree-Law 5/2025 introduced a progressive scale — the only one of its kind in Spain — and the gap against Madrid widens sharply above €600,000.

**Investors acquiring at scale should read Catalonia carefully.** That same decree created a 20% punitive ITP rate for *grandes tenedores* — individuals or entities holding more than ten urban residential properties. A U.S. investor assembling a Catalan portfolio can cross that threshold without realising the rate on subsequent acquisitions more than doubles.
...
One further note: Spain's imputed-income treatment of non-residents' own-use property has been formally challenged by the European Commission on discrimination grounds. That file is open.
...
- **Municipal caps and phase-outs.** Barcelona will not renew any of its roughly 10,100 tourist-use licences when they expire in November 2028, with rentals under 31 days ending citywide from 2029. Spain's Constitutional Court upheld the underlying Catalan framework in March 2025, so this is settled law rather than a proposal. Málaga has suspended new tourist registrations across dozens of neighbourhoods. Madrid's Plan RESIDE severely restricts scattered tourist flats within the city. The Balearics have removed thousands of licences from the market.
...
I hold a Florida real estate license, active since 2001, and operate the [Global Desk](/global-desk) — a Spain and LATAM corridor — within United Realty Group, the licensed Florida broker. For American clients acquiring in Spain, the work is threefold.
...
[Request a Global Desk acquisition review](https://homesprofessional.com/contact?utm_source=journal&utm_medium=seo&utm_campaign=spain-american-investors-2026)
...
*Nothing here is legal, tax, or financial advice, and no reader should act on it without review by a qualified Spanish tax lawyer and a U.S. cross-border tax professional.*
